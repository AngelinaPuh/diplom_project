...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const editSectionSelectForm = document.getElementById('editSectionSelectForm');
  const editSectionForm = document.getElementById('editSectionForm');
  const deleteSectionSelectForm = document.getElementById('deleteSectionSelectForm');
  ...
  deleteSectionSelectForm.addEventListener('submit', function(event) {
      event.preventDefault();
      const selectedSectionId = document.getElementById('deleteSectionSelect').value;
      if (selectedSectionId) {
  ...
  function showLectureActionDialog(sectionId, lectureCount) {
      ...
      document.getElementById('deleteLecturesButton').addEventListener('click', function() {
          closeModal();
          deleteLectures(sectionId);
      });

      document.getElementById('moveLecturesButton').addEventListener('click', function() {
          closeModal();
    ...
    function showMoveLecturesForm(sectionId) {
        ...
        formContainer.querySelector('#confirmMoveButton').addEventListener('click', function() {
        ...
        formContainer.querySelector('#cancelMoveButton').addEventListener('click', function() {
            closeModal();
        });
    }
  ...
  function fetchSectionData(sectionId) {
    return fetch(`../pages/admin_logic/section.php?action=getSection&id=${sectionId}`)
    .then(response => {
      if (!response.ok) {
        throw new Error('Network response was not ok');
      }
